...
global mobility_ maxspeed;

for simID=[1:3]
    for RunNumOfTimes=[1:21]
...
% % for isize = 10:10:(10+10*(nsize-1))
    n = imobility;
    maxspeed = imobility;
    fid = fopen([log_file, num2str(imobility)], 'r');
...
set(gca,'Box','on');
if simID==1 %for BEB
    p = polyfit(4:4:nmobility, avgColRatio,3);
    avgColRatio1 = polyval(p,4:4:nmobility);
    PT = plot(4:4:nmobility, avgColRatio1, 'bo-', 'LineWidth', 2, 'MarkerFaceColor', 'b', 'MarkerSize', 5);
elseif simID==2 %for fuzzy
    p = polyfit(4:4:nmobility, avgColRatio,3);
    avgColRatio1 = polyval(p,4:4:nmobility);
    PT = plot(4:4:nmobility, avgColRatio1, 'rx-', 'LineWidth', 2, 'MarkerFaceColor', 'r', 'MarkerSize', 5);
elseif simID==3 %for fuzzy-GA
    p = polyfit(4:4:nmobility, avgColRatio,3);
    avgColRatio1 = polyval(p,4:4:nmobility);
    PT = plot(4:4:nmobility, avgColRatio1, 'g+-', 'LineWidth', 2, 'MarkerFaceColor', 'g', 'MarkerSize', 5);
end
   
Xla = xlabel('Mobility Speed');
set(Xla,'FontSize', 12);
...
set(gca,'Box','on');
if simID==1 %for BEB
    p = polyfit(4:4:nmobility, avgresponsetime,3);
    avgresponsetime1 = polyval(p,4:4:nmobility);
    PT = plot(4:4:nmobility, avgresponsetime1, 'bo-', 'LineWidth', 2, 'MarkerFaceColor', 'b', 'MarkerSize', 5);
elseif simID==2 %for fuzzy
    p = polyfit(4:4:nmobility, avgresponsetime,3);
    avgresponsetime1 = polyval(p,4:4:nmobility);
    PT = plot(4:4:nmobility, avgresponsetime1, 'rx-', 'LineWidth', 2, 'MarkerFaceColor', 'r', 'MarkerSize', 5);
elseif simID==3 %for fuzzy-GA
    p = polyfit(4:4:nmobility, avgresponsetime,3);
    avgresponsetime1 = polyval(p,4:4:nmobility);
    PT = plot(4:4:nmobility, avgresponsetime1, 'g+-', 'LineWidth', 2, 'MarkerFaceColor', 'g', 'MarkerSize', 5);    
end
Xla = xlabel('Mobility Speed');
set(Xla,'FontSize', 12);
...
set(gca,'Box','on');
if simID==1 %for BEB
    p = polyfit(4:4:nmobility, avgthroughput,3);
    avgthroughput1 = polyval(p,4:4:nmobility);
    PT = plot(4:4:nmobility, avgthroughput1, 'bo-', 'LineWidth', 2, 'MarkerFaceColor', 'b', 'MarkerSize', 5);
elseif simID==2 %for fuzzy
    p = polyfit(4:4:nmobility, avgthroughput,3);
    avgthroughput1 = polyval(p,4:4:nmobility);
    PT = plot(4:4:nmobility, avgthroughput1, 'rx-', 'LineWidth', 2, 'MarkerFaceColor', 'r', 'MarkerSize', 5);
elseif simID==3 %for fuzzy-GA
    p = polyfit(4:4:nmobility, avgthroughput,3);
    avgthroughput1 = polyval(p,4:4:nmobility);
    PT = plot(4:4:nmobility, avgthroughput1, 'g+-', 'LineWidth', 2, 'MarkerFaceColor', 'g', 'MarkerSize', 5);
end
...
set(gca,'Box','on');
if simID==1 %for BEB
    p = polyfit(4:4:nmobility, avgenergy,2);
    avgenergy1 = polyval(p,4:4:nmobility);
    PT = plot(4:4:nmobility, avgenergy1, 'bo-', 'LineWidth', 2, 'MarkerFaceColor', 'b', 'MarkerSize', 5);
elseif simID==2 %for fuzzy
    p = polyfit(4:4:nmobility, avgenergy,2);
    avgenergy1 = polyval(p,4:4:nmobility);
    PT = plot(4:4:nmobility, avgenergy1, 'rx-', 'LineWidth', 2, 'MarkerFaceColor', 'r', 'MarkerSize', 5);
elseif simID==3 %for fuzzy-GA
    p = polyfit(4:4:nmobility, avgenergy,2);
    avgenergy1 = polyval(p,4:4:nmobility);
    PT = plot(4:4:nmobility, avgenergy1, 'g+-', 'LineWidth', 2, 'MarkerFaceColor', 'g', 'MarkerSize', 5);
end
...
set(gca,'Box','on');
if simID==1 %for BEB
    p = polyfit(4:4:nmobility, avgJanInd*simID,3);
    avgJanInd1 = polyval(p,4:4:nmobility);
    PT = plot(4:4:nmobility,avgJanInd1, 'bo-', 'LineWidth', 2, 'MarkerFaceColor', 'b', 'MarkerSize', 5);

elseif simID==2 %for fuzzy
    p = polyfit(4:4:nmobility, avgJanInd*simID,3);
    avgJanInd1 = polyval(p,4:4:nmobility);
    PT = plot(4:4:nmobility, avgJanInd1, 'rx-', 'LineWidth', 2, 'MarkerFaceColor', 'r', 'MarkerSize', 5);
elseif simID==3 %for fuzzy-GA
    p = polyfit(4:4:nmobility, avgJanInd*simID,3);
    avgJanInd1 = polyval(p,4:4:nmobility);
    PT = plot(4:4:nmobility, avgJanInd1, 'g+-', 'LineWidth', 2, 'MarkerFaceColor', 'g', 'MarkerSize', 5);
end
...
set(gca,'Box','on');
if simID==1 %for BEB
    p = polyfit(4:4:nmobility, avgPacketLossRatio,3);
    avgPacketLossRatio1 = polyval(p,4:4:nmobility);
    PT = plot(4:4:nmobility, avgPacketLossRatio1, 'bo-', 'LineWidth', 2, 'MarkerFaceColor', 'b', 'MarkerSize', 5);
elseif simID==2 %for fuzzy
    p = polyfit(4:4:nmobility, avgPacketLossRatio,3);
    avgPacketLossRatio1 = polyval(p,4:4:nmobility);
    PT = plot(4:4:nmobility, avgPacketLossRatio1, 'rx-', 'LineWidth', 2, 'MarkerFaceColor', 'r', 'MarkerSize', 5);
elseif simID==3 %for fuzzy-GA
    p = polyfit(4:4:nmobility, avgPacketLossRatio,3);
    avgPacketLossRatio1 = polyval(p,4:4:nmobility);
    PT = plot(4:4:nmobility, avgPacketLossRatio1, 'g+-', 'LineWidth', 2, 'MarkerFaceColor', 'g', 'MarkerSize', 5);
end
