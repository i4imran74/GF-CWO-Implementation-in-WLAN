...
rrep_table = []; for i=1:n, rrep_table(i).list=[]; end   % record of sent RREP
bcast_table = zeros(n, n);              % record of broadcast id
rreq_out = zeros(n, 1);
rreq_in = zeros(n, 1);
rreq_forward = zeros(n, 1);
rreq_out_crosslayer = zeros(n, 1);
rreq_in_crosslayer = zeros(n, 1);
rreq_forward_crosslayer = zeros(n, 1);
rrep_out = zeros(n, 1);
rrep_in = zeros(n, 1);
rrep_forward = zeros(n, 1);
rrep_out_crosslayer = zeros(n, 1);
rrep_in_crosslayer = zeros(n, 1);
rrep_forward_crosslayer = zeros(n, 1);
rrep_destination_crosslayer = zeros(n, 1);
%=======================================
